...
import 'package:yosrixia/features/child/profile/presentation/views/child_profile_view.dart';
import 'package:yosrixia/features/child/profile/presentation/views/doctor_profile_view.dart';
...
import 'package:yosrixia/features/appointment_booking/presentation/views/add_appointment_view.dart';
...
abstract class AppRouter {
  ...
  static const String childTracker = '/childTracker';
...
// payment routes
  ...
  static final router = GoRouter(routes: [
    ...
    GoRoute(
      path: childTracker,
      builder: (context, state) => const ChildTrackerView(),
    ),
    // payment routes
    GoRoute(
      path: walletPhone,
