    ...
    return BlocBuilder<TutorialCubit, TutorialState>(
      builder: (context, state) {
        if (state is TutorialVisible) {
          final tutorialItem = tutorialData[state.currentIndex];
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'دليل الاستخدام',
                            style: Styles.textStyle40Passion.copyWith(
                              color: kSecondaryColor,
                            ),
                          ),
                          IconButton(
                            onPressed: () {
                              context.read<TutorialCubit>().skipTutorial();
                            },
                            icon: const Icon(
                              Icons.close,
                              color: kSecondaryColor,
